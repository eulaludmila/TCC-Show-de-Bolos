...
import br.senai.sp.api.repository.CartaoClienteRepository;
...
public class CartaoClienteResource {
	...
	public List<CartaoCliente> getCartaoCliente(){
		return cartaoClienteRepository.findAll();
