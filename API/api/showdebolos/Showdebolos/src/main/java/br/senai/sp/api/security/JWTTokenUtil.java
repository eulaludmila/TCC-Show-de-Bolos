...
public class JWTTokenUtil implements Serializable {
	...
	public String generateToken(UserDetails userDetails, Long codUsuario) {
		
		Map<String, Object> claims = new HashMap<>();
		
		
		return doGenerateToken(claims, userDetails.getUsername(), codUsuario);
	}

	//Cria o token e devine tempo de expiração pra ele
	private String doGenerateToken(Map<String, Object> claims, String subject, Long codUsuario) {
