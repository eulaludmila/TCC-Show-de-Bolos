...
public class EnderecoConfeiteiroResource {
	...
	@CrossOrigin(origins = "http://localhost:3000")
	public EnderecoConfeiteiro getEnderecoConfeiteiro(@PathVariable Long codConfeiteiro){
		
		return enderecoConfeiteiroRepository.findByCodConfeiteiro(codConfeiteiro);
	}
