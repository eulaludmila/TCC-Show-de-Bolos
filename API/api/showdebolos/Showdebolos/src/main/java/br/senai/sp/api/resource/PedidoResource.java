...
//		BeanUtils.copyProperties(aprovacao, pedidoSalvo,"codConfeiteiro");
	...
	//ATUALIZAR A PRODUCAO DO PEDIDO
		@PutMapping("/producao/{codPedido}")
		@CrossOrigin(origins = "http://localhost:3000")
		public ResponseEntity<Pedido> atualizaProducaoPedido (@PathVariable Long codPedido, @RequestBody String aprovacao){
			
			Pedido pedidoSalvo = pedidoRepository.findByPedidoConfeiteiro(codPedido);
			
			pedidoSalvo.setProducao(aprovacao);
