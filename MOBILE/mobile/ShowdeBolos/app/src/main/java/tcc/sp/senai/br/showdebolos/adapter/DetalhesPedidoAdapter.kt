...
class DetalhesPedidoAdapter (private val produtos: List<ProdutoDTO>,
                             private val context: Context) : RecyclerView.Adapter<DetalhesPedidoAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        ...
        var view = LayoutInflater.from(context).inflate(R.layout.adapter_itens_pedido, viewGroup, false)
